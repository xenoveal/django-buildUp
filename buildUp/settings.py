...
SECURE_HSTS_SECONDS = 89000

LOGIN_URL = '/login'

ALLOWED_HOSTS = ['https://buildup-id.com', 'buildup-id.com']
...
EMAIL_HOST = 'mail.buildup-id.com'
EMAIL_PORT = 465
EMAIL_HOST_USER = 'verification@buildup-id.com'
EMAIL_HOST_PASSWORD = 'TFb4v_c+sf+}'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
